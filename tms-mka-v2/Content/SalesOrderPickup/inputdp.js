...
function SaveDp() {
    if ($('#TanggalDp').val() == '' || $('#PenerimaDp').val() == '' || $('#JenisDp').val() == '' || $('#IdRekeningDp').val() == '' || $('#JumlahDp').val() == '' || $('#SalesOrderPickupId').val() == '')
    {
        swal({
            title: "Error",
            type: 'error',
        ...
        var data = {
            ...
            SalesOrderPickupId: $('#SalesOrderPickupId').val(),
        }
        
        goToSavePage("/SalesOrderPickup/SaveDp/", data, GridDp.dataSource);
...
function deleteDp(e) {
    e.preventDefault();
    var data = this.dataItem(getDataRowGrid(e));
    goToDeletePage("/SalesOrderPickup/DeleteDp?IdSo=" + $("#SalesOrderPickupId").val() + "&id=" + data.Id, this.dataSource);
}
...
$(document).ready(function () {
    ...
    dsGridDp = new kendo.data.DataSource({
        transport: {
            read: {
                url: '/SalesOrderPickup/BindingDp?id=' + $('#SalesOrderPickupId').val(),
                dataType: "json"
            },
        },
        schema: {
