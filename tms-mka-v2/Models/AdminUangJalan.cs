...
namespace tms_mka_v2.Models
{
    ...
    public class AdminUangJalanUangTf
    {
        ...
        public AdminUangJalanUangTf(Context.RemovalUangTf dbitem, List<Context.Atm> listAtm)
        {
            Id = dbitem.Id;
            Nama = dbitem.Keterangan;
            Value = dbitem.Value;
            ...
            {
                Context.Atm dbattm = listAtm.Where(d => d.IdDriver == dbitem.Removal.IdDriver1).FirstOrDefault();
                if (dbattm != null)
                {
                    idRekening = dbattm.Id;
                    NoRekening = dbattm.NoRekening;
